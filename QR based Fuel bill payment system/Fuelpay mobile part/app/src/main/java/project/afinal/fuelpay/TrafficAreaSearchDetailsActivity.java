...
public class TrafficAreaSearchDetailsActivity extends Activity {
    ...
    String areaListUrl, serverResponse, Result, location, locationName,stationId,entryUrl, open, close, mobile,station_id,traffic,status,stationName,success;
    ...
    public void listViewPopulate() {
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                stationId = listStationDetailsAreaDetail.get(position).getStationid();
                stationName = listStationDetailsAreaDetail.get(position).getName();
                confirmation();
    ...
    public void confirmation(){
        new SweetAlertDialog(TrafficAreaSearchDetailsActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                .setTitleText("Are you sure?")
                .setContentText("Do you want to enter "+stationName+" ?")
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
                        ...
                        sDialog.setTitleText("Done!")
                                .setContentText("Your enter the "+stationName)
                                .setConfirmText("OK")
                        ...
                        if (internetValidation()) {
                            new Thread(new LoadTrafficEntryListTask()).start();
                            showpDialog();
                        }
    ...
    private class LoadTrafficEntryListTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                URL url = new URL(entryUrl); // here is your URL path
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (Result.equals("Exception")) {
                        new SweetAlertDialog(TrafficAreaSearchDetailsActivity.this, SweetAlertDialog.ERROR_TYPE)
