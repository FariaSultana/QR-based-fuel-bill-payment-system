    ...
    public void listViwePopulate() {
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent rowntent = new Intent(StationAreaSearchActivity.this,
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (Result.equals("Exception")) {
                        new SweetAlertDialog(StationAreaSearchActivity.this, SweetAlertDialog.ERROR_TYPE)
                                .setTitleText(getString(R.string.errorHeader))
                                .setContentText(getString(R.string.errorMessage))
                                .show();
                    } else {
                        if (success.equals("true")) {
                            mAdapter = new StationAreaAdapter(StationAreaSearchActivity.this,
